...
void print_help(void)
{
	printf(
		...
		"              Documentation about further details can be found\n"
		"              below at `Input File Documentation`.\n"
		"\n"
		...
		"        Further details can be read below, as alternative source\n"
		"        you always can check the ebnf.txt file on the github :)\n"
		"        - Annotation:\n"
