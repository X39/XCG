...
namespace yaoosl::parsing
{
    ...
    private:
        ...
        bool m_exparithmetic2_slash_expnullar_75(bool is_can, std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_2> actual, yaoosl::parsing::instance::exp_arithmetic_2_state& state);
        bool m_exparithmetic2_star_expnullar_76(bool is_can, std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_2> actual, yaoosl::parsing::instance::exp_arithmetic_2_state& state);
        bool m_expnullar_77(bool is_can, std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_2> actual, yaoosl::parsing::instance::exp_arithmetic_2_state& state);
        bool lr_can_exp_arithmetic_2();
        std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_2> lr_match_exp_arithmetic_2();
        bool m_exparithmetic1_plus_exparithmetic2_78(bool is_can, std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_1> actual, yaoosl::parsing::instance::exp_arithmetic_1_state& state);
        bool m_exparithmetic1_minus_exparithmetic2_79(bool is_can, std::shared_ptr<yaoosl::parsing::instance::exp_arithmetic_1> actual, yaoosl::parsing::instance::exp_arithmetic_1_state& state);
